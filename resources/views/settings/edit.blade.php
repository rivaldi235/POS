    ...
    <div class="card-body">
        <form action="{{ route('settings.store') }}" method="post">
            ...
            <div class="form-group">
                <label for="app_name">Nama Web</label>
            ...
            <div class="form-group">
                <label for="app_description">Deskripsi Web</label>
                <textarea name="app_description" class="form-control @error('app_description') is-invalid @enderror" id="app_description" placeholder="Deskripsi Web">{{ old('app_description', config('settings.app_description')) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input type="text" name="currency_symbol" class="form-control @error('currency_symbol') is-invalid @enderror" id="currency_symbol" placeholder="Simbol Mata Uang" value="{{ old('currency_symbol', config('settings.currency_symbol')) }}">
